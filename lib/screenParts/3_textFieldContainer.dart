...
import 'package:login_screen/reusableWidgets/customTextField.dart';
import 'package:login_screen/reusableWidgets/gradientColor.dart';
          ...
          children: <Widget>[
            Container(
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    CustomTextField(defFontSize, "EMAIL"),
                    SizedBox(height: 30),
